...
//BORRAR---------------------
LASALIDA2->data_in (P4_datS_sg);
LASALIDA2->enable_in (enable_in);
LASALIDA2->clk_in (clk_in);
LASALIDA2->data_out (LASALIDA);
///////////////////////////////////
